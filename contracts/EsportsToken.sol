...
contract EsportsToken {

    string public constant name = "EsportsToken";      //  token name
    string public constant symbol = "EST";         //  token symbol
    uint256 public constant decimals = 9;          //  token digit
    ...
    uint256 constant valueFounder = 1000000000 *  10 ** decimals;
    address owner = 0x0;
    ...
    function EsportsToken(address _addressFounder) public{
        owner = msg.sender;
